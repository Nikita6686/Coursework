...
namespace AttractionParkApp
{
    public partial class FormRegister : Form
    {
        ...
        {
            UiTheme.PrepareRegisterForm(
                this,
                lblTitle,
                new[] { txtFullName, txtLogin, txtPassword, txtConfirmPassword },
                btnRegister,
                btnCancel);

            UiTheme.StyleFieldLabel(lblFullName);
            UiTheme.StyleFieldLabel(lblLogin);
            UiTheme.StyleFieldLabel(lblPassword);
            UiTheme.StyleFieldLabel(lblConfirmPassword);
        }
